...
const ImageAnalysis: React.FC = () => {
    ...
    const [imageBase64, setImageBase64] = useState<string | null>(() => localStorage.getItem('imageAnalysis_imageBase64'));
    ...
    useEffect(() => { imageBase64 ? localStorage.setItem('imageAnalysis_imageBase64', imageBase64) : localStorage.removeItem('imageAnalysis_imageBase64'); }, [imageBase64]);
    ...
    const handleAnalysis = useCallback(async () => {
        if (!prompt.trim() || !imageBase64 || !imageMeta || isLoading) {
    ...
    }, [prompt, imageBase64, imageMeta, isLoading]);
                    ...
                    <div className="bg-gray-800/50 border border-gray-700/50 rounded-lg shadow-lg p-4 flex flex-col">
                        ...
                        {imageBase64 ? (
                            <div className="relative group">
                                <img src={`data:${imageMeta?.type};base64,${imageBase64}`} alt="Uploaded preview" className="rounded-md w-full max-h-80 object-contain" />
